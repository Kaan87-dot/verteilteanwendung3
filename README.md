...
3.  **(3P)** Implementieren Sie bitte die Warenkorbfunktionalität in
[BasketResource](src/main/java/de/berlin/htw/boundary/BasketResource.java) und
[BasketController](src/main/java/de/berlin/htw/control/BasketController.java).
Entscheiden Sie sich für eine geeignete [Datenstruktur](https://redis.io/docs/latest/develop/data-types/),
...
4.  **(1P)** Zusätzlich zu den Kundendaten sollen auch
...
5.  **(3P)** Implementieren Sie bitte die Auftragserteilung in
